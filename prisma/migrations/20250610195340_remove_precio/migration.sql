...
CREATE TABLE "Anuncio" (
    ...
    "updatedAt" DATETIME NOT NULL,
    "userId" TEXT,
    CONSTRAINT "Anuncio_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
...
-- CreateIndex
CREATE INDEX "Anuncio_titulo_idx" ON "Anuncio"("titulo");
